...
public class Criminal {
	...
	private String areaWiseCriminal;
	...
	public Criminal(String name, int age, String gender, String address, String identification, String areaOfCrime,
			String attachedCrime,String areaWiseCriminal) {
		super();
		this.name = name;
		this.age = age;
		this.gender = gender;
		...
		this.areaWiseCriminal=areaWiseCriminal;
	}
	...
	public String getAreaWiseCriminal() {
		return areaWiseCriminal;
	}


	public void setAreaWiseCriminal(String areaWiseCriminal) {
		this.areaWiseCriminal = areaWiseCriminal;
	}
	...
	public String toString() {
		return "Criminal [name=" + name + ", age=" + age + ", gender=" + gender + ", address=" + address
				...
				+ attachedCrime + ", areaWiseCriminal=" + areaWiseCriminal + "]";
	}
